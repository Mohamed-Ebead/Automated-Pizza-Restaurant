...
void SPI1_voidInit (void)
{
	...
	SPI1handle.SPIConfig.SPI_SclkSpeed  = SPI_SCLK_SPEED_DIV2;   //generates sclk of 8MHz/2 = 4MHZ
	SPI1handle.SPIConfig.SPI_DFF        = SPI_DFF_8BITS ;
	SPI1handle.SPIConfig.SPI_CPOL       = SPI_CPOL_HIGH ;
	SPI1handle.SPIConfig.SPI_CPHASE     = SPI_CPHA_HIGH ;
	SPI1handle.SPIConfig.SPI_LSBFirst   = SPI_MSB_FIRST ;
...
void SPI_Init   (SPI_Handle_t *pSPIHandle)
{
	...
	//  Frame format which bit will be transmitted first 
	Local_u32TempRegister |= pSPIHandle->SPIConfig.SPI_LSBFirst << SPI_CR1_LSBFIRST;
